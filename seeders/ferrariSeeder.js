module.exports = [
  {
    ...
    image:
      "https://phlxuexrdqzijdkoxvbe.supabase.co/storage/v1/object/public/imgs/ferrari-296-gtb-assetto-fiorano.jpg",
    price: 321400,
    description: `The 296 GTB, the evolution of Ferrari's mid-engined two-seater sports berlinetta concept, represents a complete revolution for the House of Maranello by including a new 120º V6 engine coupled to a plug-in or plug-in electric motor (PHEV) capable to deliver up to 830 CV. This car once again redefines the idea of ​​driving fun to ensure maximum excitement, not only when seeking maximum performance, but also in everyday use.`,
    brandId: 2,
    featured: true,
  },
  {
    ...
    image:
      "https://phlxuexrdqzijdkoxvbe.supabase.co/storage/v1/object/public/imgs/ferrari-sf90-spider.jpg",
    price: 507300,
    description:
  ...
  },
  {
    ...
    image:
      "https://phlxuexrdqzijdkoxvbe.supabase.co/storage/v1/object/public/imgs/Ferrari290GBT.jpg",
    price: 507300,
    description:
  ...
  },
  {
    ...
    slug: "Ferrari-Roma",
    image:
      "https://phlxuexrdqzijdkoxvbe.supabase.co/storage/v1/object/public/imgs/ferrari-roma.jpg",
    price: 507300,
    description:
